...
using Nikan.Services.Template.Core.ProjectAggregate.Events;
using Nikan.Services.Template.Core.ProjectAggregate.Handlers;
using Xunit;

namespace Nikan.Services.Template.UnitTests.Core.Handlers
{
