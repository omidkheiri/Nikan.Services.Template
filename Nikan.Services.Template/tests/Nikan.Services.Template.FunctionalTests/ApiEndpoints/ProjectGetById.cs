...
using Nikan.Services.Template.Web;
using Nikan.Services.Template.Web.Endpoints.ProjectEndpoints;
using Xunit;

namespace Nikan.Services.Template.FunctionalTests.ApiEndpoints
{
